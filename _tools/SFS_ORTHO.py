...
folder = "/home/robin/Desktop/PhD/Projects/Playing_with_NeuS/data/Data_ortho_normal/"
...
nb_split = voxels.shape[1]//voxels_max
pack_voxels = np.array_split(voxels,nb_split,axis=1)
    ...
    for nb_view in tqdm(range(RR.shape[2])):
        ...
        for face_id in range(normals.shape[1]):
            ...
            if is_visible :
                ...
                X = np.linalg.lstsq(vert,intersection)
