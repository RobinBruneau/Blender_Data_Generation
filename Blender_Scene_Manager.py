...
def generate_blender_scene():
    ...
    medium_path = ""
    output_path = ("D:/PhD/Projects/Playing_with_NeuS/data/Graphosoma_320_180_MVPS_ambiant_light_3_90/")
    ...
    cm.size = size
    #cm.sphere_cameras(radius=5, number_cameras=20, lens=50, type="perspective",size=size)
